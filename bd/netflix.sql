...
--
-- Table structure for table `users_has_actors`
--

DROP TABLE IF EXISTS `users_has_actors`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `users_has_actors` (
  `users_idUser` int NOT NULL,
  `actors_idActors` int NOT NULL,
  PRIMARY KEY (`users_idUser`,`actors_idActors`),
  KEY `fk_users_has_actors_actors1_idx` (`actors_idActors`),
  KEY `fk_users_has_actors_users1_idx` (`users_idUser`),
  CONSTRAINT `fk_users_has_actors_actors1` FOREIGN KEY (`actors_idActors`) REFERENCES `actors` (`idActors`),
  CONSTRAINT `fk_users_has_actors_users1` FOREIGN KEY (`users_idUser`) REFERENCES `users` (`idUser`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `users_has_actors`
--

LOCK TABLES `users_has_actors` WRITE;
/*!40000 ALTER TABLE `users_has_actors` DISABLE KEYS */;
/*!40000 ALTER TABLE `users_has_actors` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `users_has_movies` (
  ...
  PRIMARY KEY (`users_idUser`,`movies_idMovies`),
  KEY `fk_users_has_movies_movies1_idx` (`movies_idMovies`),
  KEY `fk_users_has_movies_users_idx` (`users_idUser`),
  CONSTRAINT `fk_users_has_movies_movies1` FOREIGN KEY (`movies_idMovies`) REFERENCES `movies` (`idMovies`),
  CONSTRAINT `fk_users_has_movies_users` FOREIGN KEY (`users_idUser`) REFERENCES `users` (`idUser`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users_has_movies` VALUES (1,1),(1,2),(2,2);
...
-- Dump completed on 2023-11-03 10:47:38
